...
export function VoicePreviewPanel({
  ...
  return (
    <div className="hidden flex-col gap-6 rounded-2xl border border-border bg-surface/70 p-6 backdrop-blur md:flex">
      ...
      <div className="flex items-center justify-center">
        <p className="font-display text-xl font-extrabold tabular-nums tracking-tight text-foreground">
