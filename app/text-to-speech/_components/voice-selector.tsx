...
import { VOICE_CATEGORY_LABELS } from "@/lib/constants/voice-categories";
...
export function VoiceSelector() {
  ...
  return (
    <div>
      <span className="font-display text-sm font-extrabold">Voice style</span>
      <Select
        value={voiceId}
        onValueChange={(v) => form.setFieldValue("voiceId", v)}
        disabled={isSubmitting}
      >
        <SelectTrigger className="mt-3 w-full h-auto gap-1 rounded-lg px-2 py-1">
          <SelectValue>
            {currentVoice && (
              <>
