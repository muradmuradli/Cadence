...
# SETUP INSTRUCTIONS
# ============================================================
# 1. Create the Modal secret with your AWS credentials:
#    modal secret create aws-s3 \
#      AWS_ACCESS_KEY_ID=<your-iam-access-key-id> \
#      AWS_SECRET_ACCESS_KEY=<your-iam-secret-access-key>
#
# 2. Create a secret for your Chatterbox API key (used to protect your endpoint):
#    modal secret create chatterbox-api-key \
#      CHATTERBOX_API_KEY=<choose-any-secret-string>
#
# 3. Create a secret for your Hugging Face token (needed to download the model):
#    modal secret create hf-token \
#      HF_TOKEN=<your-huggingface-token>
#
# 4. Fill in S3_BUCKET_NAME and S3_REGION below.
#
# 5. Test locally:
...
#
# 6. Test the deployed endpoint via curl:
...
S3_BUCKET_NAME = "amzn-modal-bucket-murad"
